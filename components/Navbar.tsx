...
// Using the thumbnail endpoint which is often more reliable for embedding than uc?export
    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <div className="flex items-center gap-3 group cursor-pointer">
          <div className="relative w-10 h-10 flex items-center justify-center">
            {!imageError ? (
              ...
              // High-fidelity fallback if the external image fails to load
        ...
        <div className="hidden md:flex items-center gap-10 text-[13px] font-bold uppercase tracking-widest text-gray-400">
          ...
          <a href="#" className="hover:text-black transition-colors">Vaults</a>
          <a href="#" className="hover:text-black transition-colors">Protocol</a>
        </div>

        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 bg-black text-white px-6 py-2.5 rounded-full text-[13px] font-bold hover:bg-zinc-800 transition-all active:scale-95 shadow-lg shadow-black/10">
